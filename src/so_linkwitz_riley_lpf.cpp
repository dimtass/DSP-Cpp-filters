...
SO_LINKWITZ_RILEY_BPF::SO_LINKWITZ_RILEY_BPF() {}

SO_LINKWITZ_RILEY_BPF::~SO_LINKWITZ_RILEY_BPF() {}

tp_coeffs SO_LINKWITZ_RILEY_BPF::calculate_coeffs(int fc, int fs)
{
	F_SIZE th = pi * fc / fs;
	F_SIZE Wc = pi * fc;
	F_SIZE k = Wc / tan(th);
...
F_SIZE SO_LINKWITZ_RILEY_BPF::filter(F_SIZE sample)
{
	F_SIZE xn = sample;
