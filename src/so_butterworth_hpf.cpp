...
SO_BUTTERWORTH_HPF::SO_BUTTERWORTH_HPF() {}

SO_BUTTERWORTH_HPF::~SO_BUTTERWORTH_HPF() {}

tp_coeffs SO_BUTTERWORTH_HPF::calculate_coeffs(int fc, int fs)
{
	F_SIZE c = tan(pi*fc / fs);
...
F_SIZE SO_BUTTERWORTH_HPF::filter(F_SIZE sample)
{
	F_SIZE xn = sample;
