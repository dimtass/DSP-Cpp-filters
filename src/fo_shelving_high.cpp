...
FO_HIGH_SHELVING_F::FO_HIGH_SHELVING_F() {}

FO_HIGH_SHELVING_F::~FO_HIGH_SHELVING_F() {}

tp_coeffs FO_HIGH_SHELVING_F::calculate_coeffs(float gain_db, int fc, int fs)
{
...
F_SIZE FO_HIGH_SHELVING_F::filter(F_SIZE sample)
{
	F_SIZE xn = sample;
