...
SO_PARAMETRIC_CQ_CUT::SO_PARAMETRIC_CQ_CUT() {}

SO_PARAMETRIC_CQ_CUT::~SO_PARAMETRIC_CQ_CUT() {}

tp_coeffs SO_PARAMETRIC_CQ_CUT::calculate_coeffs(float gain_db, float Q, int fc, int fs)
{
...
F_SIZE SO_PARAMETRIC_CQ_CUT::filter(F_SIZE sample)
{
	F_SIZE xn = sample;
